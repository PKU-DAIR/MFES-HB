...
from mfeshb.optimizer.base.utils import minmax_normalization, std_normalization
from mfeshb.surrogate.rf_ensemble import RandomForestEnsemble
...
class MFESHB(mqBaseFacade):
    ...
    def update_weight(self):
        ...
        self.logger.info('update_weight() cost %.2fs.' % (time.time()-start_time, ))
